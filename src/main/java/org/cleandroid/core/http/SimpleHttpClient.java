...
public class SimpleHttpClient {
	...
	public static org.cleandroid.core.http.PutRequest PUT(String url){
		return new org.cleandroid.core.http.PutRequest(url);
	}

	public static org.cleandroid.core.http.DeleteRequest DELETE(String url){
		return new org.cleandroid.core.http.DeleteRequest(url);
	}
