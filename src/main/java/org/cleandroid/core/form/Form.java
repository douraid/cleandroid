...
import org.cleandroid.core.http.OnHttpResponseListener;
...
public class Form<T> extends LinearLayout{
	...
	public org.cleandroid.core.form.Form<T> addSubmitButton(String buttonLabel,final Class<?> destinationActivity){
	...
	public org.cleandroid.core.form.Form<T> addSubmitButton(String buttonLabel, Integer style, Integer background, final Class<?> destinationActivity){
		Button button = null;
		if(style!=null)
	...
	public org.cleandroid.core.form.Form<T> addHttpSubmitButton(String buttonLabel, final String targetUrl, final OnHttpResponseListener onHttpResponseListener){
		Button button = createButton(context,buttonLabel);
		addView(buttonLabel, button);
		button.setOnClickListener(new OnClickListener() {
	...
	public org.cleandroid.core.form.Form<T> addHttpSubmitButton(String buttonLabel, Integer style, Integer background, final String targetUrl, final OnHttpResponseListener onHttpResponseListener){
		Button button = null;
		if(style!=null)
			button = createButton(new ContextThemeWrapper(context, style), buttonLabel);
		else button = createButton(context, buttonLabel);
	...
	public org.cleandroid.core.form.Form<T> addButton(String buttonLabel, OnClickListener onClickListener){
		Button button = createButton(context,buttonLabel);
		addView(buttonLabel,button);
	...
	public org.cleandroid.core.form.Form<T> addButton(String buttonLabel, Integer style, Integer background, OnClickListener onClickListener){
		Button button = null;
		if(style!=null)
			button = createButton(new ContextThemeWrapper(context, style), buttonLabel);
		else button = createButton(context, buttonLabel);
